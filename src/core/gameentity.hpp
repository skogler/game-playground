...
public:
	...
	inline void set_movementSpeed(unsigned short movementSpeed)
	{
		this->movementSpeed = movementSpeed;
	}
	inline unsigned short get_movementSpeed()
	{
		return movementSpeed;
	}

	inline void set_turnSpeed(unsigned short turnSpeed)
	{
		this->turnSpeed = turnSpeed;
	}
	inline unsigned short get_turnSpeed()
	{
		return turnSpeed;
	}
